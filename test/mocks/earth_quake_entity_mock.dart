...
final tEarthQuakeEntityMock = EarthQuakeEntity(
    ...
    features: [
      new FeaturesModel(
          ...
          properties: new PropertiesModel(
              mag: 4.0,
              place: "79 km E of Akutan, Alaska",
              time: 1626356256250,
              updated: 1626361517543,
              tz: null,
              url:
                  "https://earthquake.usgs.gov/earthquakes/eventpage/nc73591671",
              detail:
                  "https://earthquake.usgs.gov/earthquakes/feed/v1.0/detail/nc73591671.geojson",
              felt: 26,
              cdi: 3.8,
              mmi: 4.378,
              alert: null,
              ...
              magType: "mw",
              type: "earthquake",
              title: "M 3.7 - 31km SSW of Smith Valley, NV"),
          geometry: new GeometryModel(
              type: "Point", coordinates: [-119.4741669, 38.5245018, 3.21]),
          id: "nc73591671")
    ],
    bbox: [
      -178.9191,
